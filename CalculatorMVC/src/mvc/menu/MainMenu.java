...
public class MainMenu extends JFrame {
    ...
    public MainMenu() {
        ...
        btnPanel.add(makeMenuBtn("  Simple   ·  + – × ÷",         UIStyle.BTN_SIMPLE,  e -> openSimple()));
        btnPanel.add(makeMenuBtn("  Binaire  ·  BIN / DEC",        UIStyle.BTN_BINARY,  e -> openBinary()));
        btnPanel.add(makeMenuBtn("  Scientifique  ·  sin cos √…",  UIStyle.BTN_SCIENCE, e -> openScientific()));
    ...
    private void openSimple() {
        SimpleCalculatorModel      m = new SimpleCalculatorModel();
        SimpleCalculatorView       v = new SimpleCalculatorView();
        new SimpleCalculatorController(v, m);
        v.setVisible(true);
    }

    private void openBinary() {
        BinaryCalculatorModel      m = new BinaryCalculatorModel();
        BinaryCalculatorView       v = new BinaryCalculatorView();
        new BinaryCalculatorController(v, m);
        v.setVisible(true);
    }

    private void openScientific() {
        ScientificCalculatorModel  m = new ScientificCalculatorModel();
        ScientificCalculatorView   v = new ScientificCalculatorView();
        new ScientificCalculatorController(v, m);
        v.setVisible(true);
    }
}
